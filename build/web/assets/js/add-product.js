...
async function loadFeatures() {
    ...
    if (response.ok) {
        ...
        loadSelectOptions("category", categoryList, ["id", "name"]);
        loadSelectOptions("model", modelList, ["id", "name"]);
        loadSelectOptions("color", colorList, ["id", "name"]);
        loadSelectOptions("storage", storageList, ["id", "value"]);
    } else {
        console.log("Error");
    }
...
function updateModels() {
    ...
    let modelSelectTag = document.getElementById("model");
...
async function productListing() {
    ...
    const modelSelectTag = document.getElementById("model");
    const titleTag = document.getElementById("title");
    const descriptionTag = document.getElementById("description");
    const storageSelectTag = document.getElementById("storage");
    const colorSelectTag = document.getElementById("color");
